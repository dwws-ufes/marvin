pipeline {
    ...
    post {
        success {
            ...
            slackUploadFile channel: '#jenkins-pipeline-demo', filePath: "${JENKINS_URL}/job/${JOB_NAME}/lastBuild/consoleText", tokenCredentialId: 'slack-demo', baseUrl: 'https://hooks.slack.com/services/', teamDomain: 'Workspace do luan'
        }
    }
}
