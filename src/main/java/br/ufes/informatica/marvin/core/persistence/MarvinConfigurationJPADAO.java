...
import br.ufes.informatica.marvin.core.domain.MarvinConfiguration_;

/**
 * Stateless session bean implementing a DAO for objects of the MarvinConfiguration domain class
 * using JPA2.
 * 
 ...
 */
@Stateless
public class MarvinConfigurationJPADAO extends BaseJPADAO<MarvinConfiguration>
    implements MarvinConfigurationDAO {
  /** The unique identifier for a serializable class. */
  private static final long serialVersionUID = 1L;

  /** Logger for this class. */
  private static final Logger logger =
      Logger.getLogger(MarvinConfigurationJPADAO.class.getCanonicalName());
  ...
  @Override
  public MarvinConfiguration retrieveCurrentConfiguration()
    ...
    // Retrieves and returns the latest configuration (first entity returned). If the query returns
    // an empty list,
    // throws an exception.
    ...
    try {
      ...
      logger.log(Level.INFO,
          "Retrieve current configuration returned a MarvinConfiguration with institution \"{0}\" and creation date \"{1}\"",
          new Object[] {cfg.getInstitutionAcronym(), cfg.getCreationDate()});
      return cfg;
