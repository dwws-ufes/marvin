...
public class CreateAccountController extends JSFController {
  ...
  private static final Logger logger =
      Logger.getLogger(CreateAccountController.class.getCanonicalName());
  ...
  public void suggestShortName() {
    ...
    if ((name != null) && ((shortName == null) || (shortName.length() == 0))) {
      ...
      logger.log(Level.FINE, "Suggested \"{0}\" as short name for \"{1}\"",
          new Object[] {academic.getShortName(), name});
    } else
  ...
  public String register() {
    ...
    try {
      ...
      addGlobalI18nMessage("msgsCore", FacesMessage.SEVERITY_ERROR,
          "createAccount.error.emailAlreadyInUse.summary", new Object[] {},
          "createAccount.error.emailAlreadyInUse.detail", new Object[] {academic.getEmail()});
      return null;
    }
