...
public class UploadLattesCVServiceBean implements UploadLattesCVService {
  ...
  private static final Logger logger =
      Logger.getLogger(UploadLattesCVServiceBean.class.getCanonicalName());
  ...
  public void assignPublicationsToAcademic(Set<Publication> publications, Academic owner) {
    ...
    // FIXME: the matches need to be confirmed by calling saveMatches(). Therefore, the publications
    // should be detached
