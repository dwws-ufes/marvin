...
public class GenerateBibliographyServiceBean implements GenerateBibliographyService {
	...
	/**
	 * @see br.ufes.informatica.marvin.research.application.GenerateBibliographyService#generateBibliography(br.ufes.informatica.marvin.research.domain.BibGenConfiguration)
	 */
	@Override
