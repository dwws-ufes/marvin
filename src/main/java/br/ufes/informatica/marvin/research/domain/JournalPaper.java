...
public class JournalPaper extends Publication {
  ...
  /** Constructor. */
  public JournalPaper(String title, int year, String pages, String doi, String publisher,
      String journal, String number, String volume, String issn) {
  ...
  public String toBibTeX() {
    ...
    if (number != null && !number.isEmpty())
      builder.append("\tedition = {").append(number).append("},\n"); // edition =
                                                                     // {Journal
                                                                     // Edition},
    ...
    if (issn != null && !issn.isEmpty())
      builder.append("\tissn = {").append(issn).append("},\n"); // issn = {Journal
                                                                // ISSN},
