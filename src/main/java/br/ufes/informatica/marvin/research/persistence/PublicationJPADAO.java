...
public class PublicationJPADAO extends BaseJPADAO<Publication> implements PublicationDAO {
	...
	/**
	 * @see br.ufes.informatica.marvin.research.persistence.PublicationDAO#retrieveCountByAcademic(br.ufes.informatica.marvin.core.domain.Academic)
	 */
	@Override
	...
	/**
	 * @see br.ufes.informatica.marvin.research.persistence.PublicationDAO#retrieveByAcademic(br.ufes.informatica.marvin.core.domain.Academic)
	 */
	@Override
	...
	/**
	 * @see br.ufes.informatica.marvin.research.persistence.PublicationDAO#retrieveByAcademicAndYearRange(br.ufes.informatica.marvin.core.domain.Academic,
	 *      int, int)
	 */
	@Override
